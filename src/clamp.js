...
function clamp(element, options) {
    ...
    var self = this, win = window, opt = {
        ...
        sty = element.style, originalText = element.innerHTML,

        supportsNativeClamp = typeof (element.style.webkitLineClamp) != 'undefined', clampValue = opt.clamp,
...
// CONSTRUCTOR ________________________________________________________________
    ...
    return {
        'original': originalText, 'clamped': clampedText
    }
}
